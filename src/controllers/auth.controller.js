...
const googleCallback = asyncHandler(async (req, res) => {
  try {
    ...
    const redirectUrl = `${process.env.FRONTEND_URL || "https://pakistani-panorama.vercel.app"}/auth/google/success?token=${accessToken}`;
    ...
    res.redirect(
      `${process.env.FRONTEND_URL || "https://pakistani-panorama.vercel.app"}/auth/google/error`
    );
  }
});
